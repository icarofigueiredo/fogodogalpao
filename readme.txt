...
* Great Vibes font, TypeSETit, https://www.google.com/fonts/specimen/Great+Vibes
  Licensed under SIL Open Font License, 1.1
...
FoodHunt WordPress Theme, Copyright 2015 ThemeGrill
FoodHunt is distributed under the terms of the GNU GPL
...
= Version 0.4 =
* Missing escaping are added.

= Version 0.3 =
* Missing string translation is done.
* Header navigation menu is fixed.
* Screenshot changed.
* POT file updated.

= Version 0.2 =
* Added some features.
* Styling adjustment is done.
* Widgets and Page templates are added.
